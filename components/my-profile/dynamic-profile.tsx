          ...
          {!isEditing ? (
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3 sm:mb-4 gap-3">
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-white">{oldUser.fullName}</h2>
                  <p className="text-gray-400 text-sm sm:text-base">@{oldUser.username}</p>
                </div>
                <div >
                  <Button
              ...
              <div className="space-y-2 sm:space-y-3">
                <div>
                  ...
                  <p className="text-white text-sm sm:text-base break-all">{oldUser.email}</p>
                </div>

                {oldUser.bio && (
                  <div>
                    <p className="text-xs sm:text-sm text-gray-400">Biografía</p>
                    <p className="text-white text-sm sm:text-base">{oldUser.bio}</p>
                  </div>
                )}
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="flex flex-wrap sm:hidden gap-2">
                  <Button
                    onClick={handleCancelEdit}
                    variant="outline"
                    size="sm"
